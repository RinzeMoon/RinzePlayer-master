...
void LyricParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loaded((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->error((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LyricParser::*)(bool )>(_a, &LyricParser::loaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LyricParser::*)(const QString & )>(_a, &LyricParser::error, 1))
            return;
    }
}
...
// SIGNAL 0
void LyricParser::loaded(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void LyricParser::error(const QString & _t1)
{
