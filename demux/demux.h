...
public:
    ...
    void setNoBuffer(bool enable) { m_noBuffer = enable; }
    void setLowDelayFlag(bool enable) { m_lowDelayFlag = enable; }
    void setDiscardCorrupt(bool enable) { m_discardCorrupt = enable; }
    void setNoParse(bool enable) { m_noParse = enable; }
    void setShortProbe(bool enable) { m_shortProbe = enable; }
...
private:
    ...
    bool m_isEOF = false;
    bool m_lowLatencyMode = false; // 低延迟模式总开关
    bool m_noBuffer = true;
    bool m_lowDelayFlag = true;
    bool m_discardCorrupt = true;
    bool m_noParse = true;
    bool m_shortProbe = true;
