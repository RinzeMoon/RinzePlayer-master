...
void GlobalClock::setSpeed(double newSpeed) {
    m_audioClk.setSpeed(newSpeed);
    m_videoClk.setSpeed(newSpeed);
    m_externalClk.setSpeed(newSpeed);
}

double GlobalClock::speed() const {
    return m_audioClk.m_speed;
}
